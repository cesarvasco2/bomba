...
>>---> 💀 Pressione ctrl + c para matar o bot. 💀
...
if not ch['enable']:
    print('>>--->Recurso de casa não ativado')
print('\n')
...
def alertCaptcha():
    ...
    test = telegram_bot_sendtext("🧩 IA RESOLVENDO NOVO CAPTCHA!")
...
def goSaldo():
    ...
    if float(saldoApurado) > float(saldo_atual):
        ...
        #envia a foto do saldo
        img_saldo_dir = os.path.dirname(os.path.realpath(__file__)) + r'\targets\csaldo1.png'
        telegram_bot_sendphoto(img_saldo_dir)
